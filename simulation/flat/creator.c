...
garbageStruct garbagesArray1[MAX_NUMBERS_OF_GARBAGES_IN_ROOM];
pthread_mutex_t garbagesMutex1 = PTHREAD_MUTEX_INITIALIZER;
garbagesStruct garbages1 = {garbagesArray1, 0, &garbagesMutex1};
...
garbageStruct garbagesArray2[MAX_NUMBERS_OF_GARBAGES_IN_ROOM];
pthread_mutex_t garbagesMutex2 = PTHREAD_MUTEX_INITIALIZER;
garbagesStruct garbages2 = {garbagesArray2, 0, &garbagesMutex2};
...
garbageStruct garbagesArray3[MAX_NUMBERS_OF_GARBAGES_IN_ROOM];
pthread_mutex_t garbagesMutex3 = PTHREAD_MUTEX_INITIALIZER;
garbagesStruct garbages3 = {garbagesArray3, 0, &garbagesMutex3};
...
garbageStruct garbagesArray4[MAX_NUMBERS_OF_GARBAGES_IN_ROOM];
pthread_mutex_t garbagesMutex4 = PTHREAD_MUTEX_INITIALIZER;
garbagesStruct garbages4 = {garbagesArray4, 0, &garbagesMutex4};
...
garbageStruct garbagesArray5[MAX_NUMBERS_OF_GARBAGES_IN_ROOM];
pthread_mutex_t garbagesMutex5 = PTHREAD_MUTEX_INITIALIZER;
garbagesStruct garbages5 = {garbagesArray5, 0, &garbagesMutex5};
...
garbageStruct garbagesArray6[MAX_NUMBERS_OF_GARBAGES_IN_ROOM];
pthread_mutex_t garbagesMutex6 = PTHREAD_MUTEX_INITIALIZER;
garbagesStruct garbages6 = {garbagesArray6, 0, &garbagesMutex6};
...
garbageStruct garbagesArray7[MAX_NUMBERS_OF_GARBAGES_IN_ROOM];
pthread_mutex_t garbagesMutex7 = PTHREAD_MUTEX_INITIALIZER;
garbagesStruct garbages7 = {garbagesArray7, 0, &garbagesMutex7};
...
{
    for (size_t roomId = 0; roomId < roomsInFlat.numOfRooms; roomId++)
    {
        createGarbagesInRoom(
            roomsArray[roomId]->garbages,
            roomsArray[roomId]->walls->walls[0].startXY[0],
            roomsArray[roomId]->walls->walls[0].startXY[1],
            roomsArray[roomId]->walls->walls[1].endXY[0],
            roomsArray[roomId]->walls->walls[1].endXY[1]);
    }
}
